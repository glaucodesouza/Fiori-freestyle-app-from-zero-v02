		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Picking de Transferência",
									"targetURL": "#freestyledozerov02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"freestyledozerov02-display": {
								"semanticObject": "freestyledozerov02",
								"action": "display",
								"description": "Picking de Transferência",
								"title": "Picking de Transferência",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=freestyledozerov02",
									"url": sap.ui.require.toUrl("freestyledozerov02")
								}
							}
						}
					}
